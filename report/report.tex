...
\end{defi}
\begin{defi}
The \textit{local feature size} is the distance to the medial axis.
\end{defi}
...
Otherwise, we replace p$_j$ by the path obtained by concatenating p$_j$ before the intersection, then p$_1$ and then the rest of p$_j$. [fig] This can be done in O(\MinC + p$_j$) (we just need to verify the intersection and to link suitably p$_j$ and p). \\
